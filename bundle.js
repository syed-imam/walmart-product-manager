 ...
 */
var walmartApiEndpoint = _config2.default.walmartSearchAPI.apiEndPoint;
var walmartApiKey = _config2.default.walmartSearchAPI.apiKey;

var queries = ['cereal', 'cold cereal'];

_axios2.default.get(walmartApiEndpoint + "?query=" + queries[0] + "&format=json&facet=on&apiKey=" + walmartApiKey).then(function (response) {
